...
-- Complete database schema for the Nexus real-time collaboration platform
-- Generated from migration files for git clone and build readiness
...
-- Schema migrations tracking table (for migration system)
